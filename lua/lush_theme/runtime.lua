...
function M.apply_overrides(c)
	...
	set_hl("@type.builtin.rust", { link = "Type" })
	set_hl("@type.rust", { link = "Type" })
	...
	set_hl("@punctuation.bracket.rust", { fg = c.accent_dim_fg })
	...
	set_hl("@keyword.rust", { fg = c.title_fg })
	set_hl("@keyword.function.rust", { fg = c.accent_hot_fg, bold = true, cterm = { bold = true } })
	set_hl("@keyword.repeat.rust", { fg = c.fg, italic = true, cterm = { italic = true } })
	set_hl("@keyword.operator.rust", { fg = c.fg, italic = true, cterm = { italic = true } })
	set_hl("@keyword.conditional.rust", { fg = c.accent_hot_fg })
	...
	set_hl("@punctuation.special.rust", { fg = c.accent_hot_fg })
	...
	set_hl("@function.call.rust", { link = "Normal" })
	set_hl("@function.method.call.rust", { link = "Constant" })
	set_hl("@function.macro.rust", { link = "Constant" })
	...
	set_hl("@lsp.type.property.rust", { link = "Constant" })
	...
	set_hl("@lsp.typemod.property.defaultLibrary.rust", { link = "Constant" })
	...
	set_hl("@lsp.typemod.property.readonly.rust", { link = "Constant" })
	...
	set_hl("@lsp.typemod.property.declaration.rust", { link = "Constant", nocombine = true })
	set_hl("@boolean.typescript", { link = "Normal" })
	set_hl("@boolean.rust", { link = "Normal" })
	...
	set_hl("@lsp.type.type.rust", { link = "Type" })
	set_hl("@lsp.type.class.rust", { link = "Type" })
	set_hl("@lsp.type.enum.rust", { link = "Type" })
	set_hl("@lsp.type.struct.rust", { link = "Type" })
	set_hl("@lsp.type.interface.rust", { link = "Type" })
	set_hl("@lsp.typemod.type.declaration.rust", { link = "Normal", nocombine = true })
	set_hl("@lsp.typemod.class.declaration.rust", { link = "Normal", nocombine = true })
